...
> **Welcome to Service-Track Week 8, Task 3!**
...
| `src/ticketClassifier.py` | Main source code - **has bugs to fix** |
| `src/ticketRouter.py` | Supporting code - **may also have bugs** |
| `tests/test_ticketClassifier.py` | Test file - **add your tests here** |
...
### Incident - `src/ticketClassifier.py`
**User Report / Alert:**
> "', 'crash', 'slow', 'timeout', 'api', 'integration'],"
...
### Incident - `src/ticketClassifier.py`
**User Report / Alert:**
> "Priority weights are inverted — critical gets lowest score (1),"
...
### Incident - `src/ticketClassifier.py`
**User Report / Alert:**
> "Case-sensitive matching — Payment won't match payment."
